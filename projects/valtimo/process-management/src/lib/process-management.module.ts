...
import {CarbonTableModule, ListModule, WidgetModule} from '@valtimo/components';
...
import {ButtonModule, IconModule, TableModule, TagModule} from 'carbon-components-angular';
